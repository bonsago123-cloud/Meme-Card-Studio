...
export function render(ctx,s,img){
  ...
  if(img){
    ...
    const drawX=centerX-drawWidth/2, drawY=centerY-drawHeight/2;
    ctx.drawImage(img,sx,sy,sw,sh,drawX,drawY,drawWidth,drawHeight);
    imageBox={x:drawX,y:drawY,width:drawWidth,height:drawHeight,centerX,centerY,handleX:drawX+drawWidth,handleY:drawY+drawHeight};
